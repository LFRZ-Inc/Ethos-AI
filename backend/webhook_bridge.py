...
class WebhookBridge:
    """Webhook-based bridge for Railway to local Ollama communication"""
    
    def __init__(self):
        # Use webhook.site for testing - you can replace with your own webhook service
        self.webhook_url = "https://webhook.site/your-unique-id"
    ...
    def send_to_local_ollama(self, message: str, model_id: str = "ethos-light") -> Optional[str]:
        """Send request to local Ollama via webhook"""
        try:
