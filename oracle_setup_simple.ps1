...
# Simple version that generates the bash script

Write-Host "🚀 Setting up Oracle Cloud infrastructure for Ethos AI..." -ForegroundColor Green

# Your Oracle Cloud details
$TenancyOCID = "ocid1.tenancy.oc1..aaaaaaaaarh4yq7yrr2fmxzlbsqioh2ask7pkudub2yy4kd2hj63gj7j2mvhq"
$UserOCID = "ocid1.user.oc1..aaaaaaaaxa2ie62bo5iltjhdzmwzebmxmsq43hbj2nbf2qedjjyno2cyikiq"
$CompartmentOCID = "ocid1.compartment.oc1..aaaaaaaackdia2a376x4br4x3p3mgfunjvtbs2ht67qncr4yx5s3lkroroxq"
$Region = "us-chicago-1"
$SSHPublicKey = "ssh-rsa  cooli@LuisAsusPC"

Write-Host "📋 Your Oracle Cloud Details:" -ForegroundColor Cyan
Write-Host "Tenancy OCID: $TenancyOCID" -ForegroundColor White
Write-Host "User OCID: $UserOCID" -ForegroundColor White
Write-Host "Compartment OCID: $CompartmentOCID" -ForegroundColor White
...
$BashScript | Out-File -FilePath "oracle_infrastructure_setup.sh" -Encoding UTF8

Write-Host "✅ Created infrastructure setup script: oracle_infrastructure_setup.sh" -ForegroundColor Green

Write-Host "📋 Next Steps:" -ForegroundColor Yellow
Write-Host "1. Install Oracle Cloud CLI (if not already installed)" -ForegroundColor White
Write-Host "2. Configure your API key and fingerprint" -ForegroundColor White
Write-Host "3. Run: bash oracle_infrastructure_setup.sh" -ForegroundColor White
Write-Host "4. SSH into your VM and install Ethos AI" -ForegroundColor White

Write-Host "🔑 Your SSH Public Key:" -ForegroundColor Cyan
Write-Host $SSHPublicKey -ForegroundColor White

Write-Host "🎯 Capacity Type: Use 'On-demand capacity' (already selected)" -ForegroundColor Green
